        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Tambah Data Sandar Kapal</h1>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                        ...
                                        $sql = "INSERT INTO data_sandar (NamaKapal, PBM, Barang, Dermaga, Meteran, IkatTali, MulaiKegiatan, TonManifest, TonRealisasi, Persentase)
                                    VALUES ('$namaKapal', '$pbm', '$barang', '$dermaga', '$meteran', '$ikatTali', '$mulaiKegiatan', '$tonManifest', '$tonRealisasi', '$persentase')";
