...
if (!isset($_GET['id'])) {
    header("Location: Sailing.php");
    exit();
}

$id = $_GET['id'];

$sql = "SELECT * FROM sailing WHERE Id = '$id'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE sailing SET NamaKapal = '$namaKapal', PBM = '$pbm', Barang = '$barang', Dermaga = '$dermaga', Meteran = '$meteran', 
            IkatTali = '$ikatTali', MulaiKegiatan = '$mulaiKegiatan', SelesaiKegiatan = '$selesaiKegiatan', LepasTali = '$lepasTali', 
            TonManifest = '$tonManifest', TonRealisasi = '$tonRealisasi', Persentase = '$persentase', Status = '$status' WHERE Id = '$id'";
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Edit Sailing Data</h1>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post" action="<?php echo $_SERVER["PHP_SELF"] . '?id=' . $id; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="selesai_kegiatan" value="<?php echo $row['SelesaiKegiatan']; ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="lepas_tali">Lepas Tali:</label>
                                            <input type="date" class="form-control" name="lepas_tali" value="<?php echo $row['LepasTali']; ?>" required>
                                        </div>
                                        <div class="form-group">
